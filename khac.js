document.querySelector('head').innerHTML = ' <meta charset="UTF-8">\n' +
    ...
    '    <title>8A5\'s website - Khác</title>\n' +
    '    <link rel="icon" href="img/8a5logo.png">\n' +
    '    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/nguyen2234/8A5website@main/CSS/style.css">\n' +
    '    <meta name="description" content="Trang khác của 8A5\'s website, chứa một số thông tin bên lề khác">' +
...
document.querySelector('body').innerHTML += '<header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">\n' +
    ...
    '        <h1 class="display-5 fw-bold">Khác....</h1>\n' +
    ...
    '\n' +
    '    <main>\n' +
    '        <div id="tkb" style="border-bottom: 10px solid blue !important; padding-bottom: 90px;" class="px-4 pt-5 my-5 text-center border-bottom">\n' +
    '            <h1 class="display-4 fw-bold">Thời Khóa Biểu </h1>\n' +
    '            <div class="col-lg-6 mx-auto">\n' +
    '                <p class="lead mb-4">Thời khóa biểu của lớp mình :))</p>\n' +
    '            </div>\n' +
    '            <div class="container">\n' +
    '                <iframe class="responsive-iframe" src="https://8a5-forum.forumvi.com/t1-topic#1"></iframe>\n' +
    '            </div>\n' +
    '            <button onclick="window.open(\'https://8a5-forum.forumvi.com/t1-topic#1\')" type="button" class="btn btn-primary btn-lg px-4 gap-3">Mở trang thời khoá biểu trong tab mới</button>\n' +
    '        </div>\n' +
    '    </main>\n' +
    '\n' +
    '\n' +
