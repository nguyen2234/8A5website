...
document.querySelector('body').innerHTML += '<header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">\n' +
    ...
    '        <h1 class="display-5 fw-bold">Liên Lạc</h1>\n' +
    ...
    '            <h1 class="display-4 fw-bold">Các hình thức liên lạc</h1>\n' +
    '        </div>\n' +
    ...
    '                </div>\n' +
    '                <h2>Zalo</h2>\n' +
    '                <button onclick="window.location.href = \'https://zalo.me/g/kjzofl328\'" type="button" class="btn btn-primary btn-lg px-4 gap-3">Zalo</button>\n' +
    '            </div>\n' +
    '        </div>\n' +
    '    </main>\n' +
    '\n' +
